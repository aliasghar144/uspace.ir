...
class TestScreen extends StatelessWidget {
    ...
    return Scaffold(
      body: SafeArea(
        child: RefreshIndicator(
          ...
          onRefresh: () async {
            return onRefresh(reservationController,'berenjestanak');
          },
                ...
                child: Column(
                  children: [
                    IconButton(
                      icon: Icon(Icons.add),
                      onPressed: (){
                        reservationController.commentsPages.value = 4;
  ...
  imageSec(ReservationController reservationController) { return Obx(()
  {
    if(reservationController.loading.value){
      return Column(
        children: [
      ...
      if( reservationController.loading.value || reservationController.loadingRoom.value){
        ...
        return ScrollConfiguration(
          ...
          child: SingleChildScrollView(
              ...
              dragStartBehavior: DragStartBehavior.down,
              child: Column(
                  key: reservationController.key1,
                  children: [
                const SizedBox(height: 20),
                ListView.separated(
  ...
  comments(ReservationController reservationController) {
    return Obx((){
      if(reservationController.loading.value){
        ...
        if (reservationController.commentList.isEmpty) {return const SizedBox();}else{
          return ScrollConfiguration(
            behavior: const ScrollBehavior().copyWith(overscroll: false),
            child: SingleChildScrollView(
              physics: const NeverScrollableScrollPhysics(),
              child: Obx(() => Column(
                ...
                children: [
                  ...
                  ListView.separated(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                              ...
                                              decoration:BoxDecoration(
                                                borderRadius: BorderRadius.circular(8),
                                                border: Border.all(
                                                  width:0.5,color:AppColors.grayColor,
                                                ),
                                              ),
                                              child: Text('رزرور کننده نیست',style: Theme.of(Get.context!).textTheme.titleSmall!.copyWith(color: AppColors.grayColor))) : const SizedBox(),
                                          const SizedBox(width:5),
                                        ...
                                        child: Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              const Icon(Icons.reply_rounded,size: 15,color:AppColors.mainColor,),
                                            ],
                                          ),
                                        ),
                                      ),
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(DateTime.parse(reservationController.commentList[index].replies[commentIndex].replyDate?? DateTime.now().toString()).toPersianDateStr(strMonth: true), style: Theme.of(Get.context!).textTheme.titleMedium!.copyWith(color: AppColors.grayColor),textDirection: TextDirection.rtl,),
                                                    const Divider(height: 5,),
                                                    Text(reservationController.commentList[index].replies[commentIndex].replyComment!,textAlign: TextAlign.right,textDirection: TextDirection.rtl,style: Theme.of(Get.context!).textTheme.titleMedium,),
                                                  ],
                                                ),
                                              ),
                                              const SizedBox(width:5),
                                              Container(
                                                ...
                                                child: CachedNetworkImage(imageUrl: reservationController.commentList[index].replies[commentIndex].replyAvatar ?? '',errorWidget: (context, url, error) {
                                                  return Container(
                                                    clipBehavior: Clip.hardEdge,
                                                    width: 30,
                                                    height: 30,
                                  ...
                                  [
                                    Tooltip(
                                      ...
                                      child:customProgress(
                                          width: Get.width/9,
                                          centerText: reservationController.commentList[index].option1?.point ?? '-',
                                          endColor: AppColors.mainColor,
                                          startColor: AppColors.mainColor,
                                          fontSize: 10,
                                          percent: double.parse(reservationController.commentList[index].option1?.point ?? '0') / 10,
                                          footer: 'امتیاز کلی',
                                          radius: 15),
                                    ),
                                    Tooltip(
                                      ...
                                      child:                                       customProgress(
                                          width: Get.width/9,
                                          centerText: reservationController.commentList[index].option2?.point ?? '-',
                                          endColor: AppColors.mainColor,
                                          startColor: AppColors.mainColor,
                                          fontSize: 10,
                                          percent: double.parse(reservationController.commentList[index].option2?.point ?? '0') / 10,
                                          footer: 'تمیزی اتاق',
                                          radius: 15),
                                    ),
                                    Tooltip(
                                      ...
                                      triggerMode: TooltipTriggerMode.tap,
                                      child:                                       customProgress(
                                          centerText: reservationController.commentList[index].option3?.point ?? '_',
                                          endColor: AppColors.mainColor,
                                          startColor: AppColors.mainColor,
                                          width: Get.width/9,
                                          fontSize: 10,
                                          percent: double.parse(reservationController.commentList[index].option3?.point ?? '0') / 10,
                                          footer: 'کیفیت و تنوع غذا',
                                          radius: 15),
                                    ),
                                    Tooltip(
                                      ...
                                      triggerMode: TooltipTriggerMode.tap,
                                      child:                                       customProgress(
                                          centerText: reservationController.commentList[index].option4?.point ?? '-',
                                          endColor: AppColors.mainColor,
                                          width: Get.width/9,
                                          startColor: AppColors.mainColor,
                                          fontSize: 10,
                                          percent: double.parse(reservationController.commentList[index].option4?.point ?? '0') / 10,
                                          footer: 'برخورد پرسنل',
                                          radius: 15),
                                    ),
                                    Tooltip(
                                      ...
                                      triggerMode: TooltipTriggerMode.tap,
                                      child:                                       customProgress(
                                          centerText: reservationController.commentList[index].option5?.point ?? '-',
                                          endColor: AppColors.mainColor,
                                          width: Get.width/9,
                                          startColor: AppColors.mainColor,
                                          fontSize: 10,
                                          percent: double.parse(reservationController.commentList[index].option5?.point ?? '0') / 10,
                                          footer: 'رضایت از سایت رزرو',
                                          radius: 15),
                                    ),
                                  ],
                                ),
                      ...
                      separatorBuilder: (context, index) {
                        return const Divider(height: 25,thickness: 1.25,);
                      },
                      ...
                      if(!reservationController.loadMore.value){
                        return TextButton(
                          onPressed: (){
                            ...
                            child: const Text('بارگزاری نظرات بیشتر')),);
                      }else{
                        return SizedBox(
                          width: Get.width / 7,
                          height: Get.width / 6.5,
  ...
  cancelingRules(ReservationController reservationController) {
    if(reservationController.loading.value){return const SizedBox();}else{
      return Column(
          children:[
            Container(
              margin: const EdgeInsets.symmetric(horizontal:15),
  ...
  suggestion(ReservationController reservationController) {
    return Obx(() { if(reservationController.loading.value){
      return Column(
        children:[
