              ...
              children:[
                ...
                if(searchController.loading.value) ...[
                  ...
                  Padding(
                    ...
                    child: Text(searchController.firstOpen.value ? '' : 'موردی یافت نشد', style: Theme
                        .of(context)
                        .textTheme
                        .headlineSmall!
                                    ...
                                    if ( searchController.searchEcolodgesResult[index].maxDiscountPercent != null && searchController.searchEcolodgesResult[index].maxDiscountPercent !> 0)
                                      Positioned(
                                        ...
                                        child: Container(
                                          ...
                                          child: Center(child: Text('${searchController.searchEcolodgesResult[index].maxDiscountPercent}%', style: Theme
                                              .of(context)
                                              .textTheme
                                              .bodySmall!
