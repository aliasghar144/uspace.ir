      ...
      Dialog(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          Obx(() => Row(children: [
                ...
                reservationController.commentList.isEmpty
                    ? const SizedBox()
                    : Flexible(
                        child: InkWell(
                          borderRadius: const BorderRadius.only(topRight: Radius.circular(18)),
                                            ...
                                            children: [
                                              reservationController.commentList[index].type != 'feedback'
                                                  ? Container(
                                                      ...
                                                      child: Text('رزرور کننده نیست', style: Theme.of(Get.context!).textTheme.titleSmall!.copyWith(color: AppColors.grayColor)))
                                                  : const SizedBox(),
                                              const SizedBox(width: 5),
