...
class FilterScreen extends StatelessWidget {
    ...
    return Scaffold(
        ...
        bottomNavigationBar: SizedBox(
          ...
          child: Padding(
            ...
            ), child: Text('اعمال فیلتر',style: Theme.of(context).textTheme.bodyLarge!.copyWith(color:Colors.white),)),
          ),
        ),
        body: SafeArea(
          child: Column(
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text('قیمت هر شب',style: Theme.of(context).textTheme.bodyMedium,),
                              ),
                              Obx(() =>RangeSlider(
                                divisions: 100,
                            values: RangeValues(start.value, end.value),
                            labels: RangeLabels('${formatAmount(start.value.round()*500000)}تومان','${formatAmount(end.value.round()*500000)}تومان'),
                            onChanged: (value) {
                            ...
                            max: 100,
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Obx(() => Text('${formatAmount(start.value.round()*500000)} تومان',style:Theme.of(context).textTheme.labelLarge)),
                                    Obx(() => Text('${formatAmount(end.value.round()*500000)} تومان',style:Theme.of(context).textTheme.labelLarge)),
                                  ],
                                ),
                              ),
                            ],
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        style: Theme.of(context)
                                            .textTheme
                                            .bodyMedium!
                                            .copyWith(color: const Color(0xff051726)),
                                      ),
                                    ],
                                  ),
                                  childrenPadding: const EdgeInsets.only(
  ...
  void setRange(double start,double end) {
    this.start.value = start;  //updating the value of Rx Variable.
    this.end.value = end;  //updating the value of Rx Variable.
  }
}
